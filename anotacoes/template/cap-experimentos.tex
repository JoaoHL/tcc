...
\begin{figure}[H]
	\centering
	\includegraphics[width=13cm]{figuras/grafico-huffman}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|} \hline
		...
		120  & 45.496.549   & 12.77.070,90 \\\hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=13cm]{figuras/grafico-tsp}
...
Da mesma forma, para o algoritmo de Rosenkrantz-Stern-Lewis, para um grafo de $192$ vértices, temos o tempo de execução, em segundos, apresentados em \ref{calculo-tempo-hardware-tsp} e \ref{calculo-tempo-software-tsp}.
...
Há evidências, portanto, que a utilização de um \textit{hardware} dedicado e uma máquina de propósito geral podem apresentar desempenhos muito similares no que diz respeito ao tempo de execução.
