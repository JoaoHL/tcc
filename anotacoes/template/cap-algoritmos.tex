...
Na figura \ref{grafo-2tsp}, as arestas pertencentes à árvore geradora mínima têm peso $5$, enquanto todas as outras arestas do grafo $G$ possuem peso $10$. Os módulos dos pesos foram escolhidos de tal forma que o grafo obedeça à desiguldade triangular para qualquer subconjunto de arestas de $G$. O peso total de um caminho ótimo de tal grafo pode ser calculado pela expressão \ref{equacao-caminho-otimo}, e o caminho é ilustrado na figura \ref{grafo-caminho-otimo}.
