...
%\usepackage[plainpages=false,pagebackref,colorlinks=true,citecolor=DarkGreen,linkcolor=NavyBlue,urlcolor=DarkRed,filecolor=green,bookmarksopen=true]{hyperref} % links coloridos para pstricks
...
\renewcommand{\algorithmicreturn}{\textbf{Devolve}}
...
\input cap-introducao        % associado ao arquivo: 
\input cap-fpga
\input cap-conceitos
\input cap-legup
